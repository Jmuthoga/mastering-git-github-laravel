...
1. Visit the class repository provided by your instructor. For this course use:
   ...
   https://github.com/Jmuthoga/mastering-git-github-laravel
...
3. Now you have:
   ...
   * Original repo (class repo): `https://github.com/Jmuthoga/mastering-git-github-laravel.git`
   * Your fork: `github.com/<your-username>/mastering-git-github-laravel.git`
...
git clone https://github.com/<your-username>/mastering-git-github-laravel.git
cd mastering-git-github-laravel.git
```

If you want to try a quick demo without forking first, you can clone the original class repo directly (read-only):

```bash
git clone https://github.com/Jmuthoga/mastering-git-github-laravel.git
cd mastering-git-github-laravel.git
```
...
```bash
git add students.md
git commit -m "Add John M to students list"
...
1. Change the **base repository** when opening the PR to point at the class repo (only if the instructor allows outside PRs).
   ...
   * Base repo (example): `Jmuthoga/mastering-git-github-laravel.git`
   * Base branch: `main`
...
1. Fork the class repo `mastering-git-github-laravel.git` (provided by instructor):

  https://github.com/Jmuthoga/mastering-git-github-laravel.git
...
7. (Optional advanced) Open a PR to the original `mastering-git-github-laravel.git`.
8. **Submission:** Post the **link to your Pull Request** in the "intro to git and github" channel on Discord (invite: https://discord.gg/wcFzwswv).
