...
4. **Submission:** Post the **GitHub repo link** and both branch names in the "intro to git and github" channel on Discord (invite: https://discord.gg/wcFzwswv). Please include:
